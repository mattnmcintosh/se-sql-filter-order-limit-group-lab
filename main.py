...
# STEP 12
# Replace None with your code
df_at_bats = pd.read_sql("""SELECT team, AVG(at_bats) as average_at_bats FROM babe_ruth_stats GROUP BY team HAVING AVG(at_bats) > 200 ORDER BY average_at_bats DESC; """, conn3)
